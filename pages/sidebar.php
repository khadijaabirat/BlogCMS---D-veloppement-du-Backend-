    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 <?= ($current_page == 'dashboard') ? 'shadow-soft-xl rounded-lg bg-white font-semibold' : '' ?> text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 text-slate-700 transition-colors" href="dashboard.php">
                    <div class="<?= ($current_page == 'dashboard') ? 'bg-gradient-to-tl from-purple-700 to-pink-500' : 'bg-white' ?> shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1716.000000, -439.000000)" fill="<?= ($current_page == 'dashboard') ? '#FFFFFF' : '#252f40' ?>" fill-rule="nonzero">
            ...
            <!-- Articles -->
            <li class="mt-0.5 w-full">
                <a class="py-2.7 <?= ($current_page == 'posts') ? 'shadow-soft-xl rounded-lg bg-white font-semibold' : '' ?> text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 text-slate-700 transition-colors" href="posts.php">
                    <div class="<?= ($current_page == 'posts') ? 'bg-gradient-to-tl from-purple-700 to-pink-500' : 'bg-white' ?> shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1869.000000, -293.000000)" fill="<?= ($current_page == 'posts') ? '#FFFFFF' : '#252f40' ?>" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
            ...
            <!-- Catégories -->
            <li class="mt-0.5 w-full">
                <a class="py-2.7 <?= ($current_page == 'categories') ? 'shadow-soft-xl rounded-lg bg-white font-semibold' : '' ?> text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 text-slate-700 transition-colors" href="categories.php">
                    <div class="<?= ($current_page == 'categories') ? 'bg-gradient-to-tl from-purple-700 to-pink-500' : 'bg-white' ?> shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center fill-current stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 43 36" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-2169.000000, -745.000000)" fill="<?= ($current_page == 'categories') ? '#FFFFFF' : '#252f40' ?>" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 <?= ($current_page == 'users') ? 'shadow-soft-xl rounded-lg bg-white font-semibold' : '' ?> text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 text-slate-700 transition-colors" href="users.php">
                    <div class="<?= ($current_page == 'users') ? 'bg-gradient-to-tl from-purple-700 to-pink-500' : 'bg-white' ?> shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1717.000000, -291.000000)" fill="<?= ($current_page == 'users') ? '#FFFFFF' : '#252f40' ?>" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
            ...
            <!-- Comments (Admin only) -->
            <li class="mt-0.5 w-full">
                <a class="py-2.7 <?= ($current_page == 'comments') ? 'shadow-soft-xl rounded-lg bg-white font-semibold' : '' ?> text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 text-slate-700 transition-colors" href="comments.php">
                    <div class="<?= ($current_page == 'comments') ? 'bg-gradient-to-tl from-purple-700 to-pink-500' : 'bg-white' ?> shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1870.000000, -591.000000)" fill="<?= ($current_page == 'comments') ? '#FFFFFF' : '#252f40' ?>" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
            ...
            <li class="w-full mt-4">
                <h6 class="pl-6 ml-2 font-bold leading-tight uppercase text-xs opacity-60">Mon Compte</h6>
            </li>

            <!-- Logout -->
            <li class="mt-0.5 w-full">
                <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 text-slate-700 transition-colors" href="logout.php">
                    <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1720.000000, -592.000000)" fill="#252f40" fill-rule="nonzero">
                                    <g transform="translate(1716.000000, 291.000000)">
